...
load(file="I:/PD&COPD/data/Interpolation_weighted.Rdata")
...
var<-c("MORT_stat","Age_status","Sex","Race_ethnicity","Education_levels","PIR",
...
VAR<-c("MORT_stat","CAL_mean","PPD_mean","Age","Age_status","Sex","Race_ethnicity","Education_levels","PIR",
...
save(Table1,file = "I:/PD&COPD/data/Table1_Rdata")  
...
load(file = "I:/PD&COPD/data/Table1_Rdata")
...
Table_1<-Table
write.table(Table_1,sep = ",",file ="I:/PD&COPD/result/Table 1.csv" ,row.names =F,col.names =F )
}
...
Table<-rbind(Table,c("High",
                     ...
                     "" ))
Table_S3<-Table
write.table(Table_S3,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 3.csv" ,row.names =F,col.names =F )
}
...
{ #* all model #####
  ...
  model2<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PD_diagnosis+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
  ...
  model3<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PD_diagnosis+Age_status+Sex+Race_ethnicity+SES+
...
{ #* Combine #####
  ...
  Table_2
  write.table(Table_2,sep = ",",file ="I:/PD&COPD/result/Table 2.csv",row.names =F,col.names =F )
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 20 Weiboll model (Table 3) ####  
rhcSvy<-subset(rhcSvy,peryear>0)
{ #* all model #####
  #all Crude
  ...
  #all model 2
  model<-svysurvreg(Surv(peryear, MORT_stat==1) ~
                      PD_diagnosis+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy,dist="weibull")
  model_result<-summary(model)
  model_result
  HR<-exp(model_result[["coefficients"]][2])
  lower<-exp(model_result[["coefficients"]][2]-1.96*model_result[["table"]][,2][2])
...
{ #* Combine #####
  ...
  write.table(Table_3,sep = ",",file ="I:/PD&COPD/result/Table 3.csv",row.names =F,col.names =F )
}
...
{ #* all model #####
  ...
  model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         Periodontitis+Age_status+Sex+Race_ethnicity+SES+
                         Smoking_status+Drinking_status+BMI_status+Physical_status+
...
{ #* section 21.3 Combine  Table 4#####
  ...
  write.table(Table_4,sep = ",",file ="I:/PD&COPD/result/Table 4.csv" ,row.names =F,col.names =F )
...
{ #* ALL Mortality Figure 1A ####
  ...
  print(Figure_1A)
  topptx(filename = "I:/PD&COPD/result/Figure_1A1.pptx", width = 8, height = 6)
  Figure_1A<-ggsurvplot(FIT_ALL_PD,conf.int =TRUE, tables.theme = theme_cleantable(), palette=c("#0073C2E5", "#EFC000E5"), 
                        ncensor.plot=F,risk.table = T,
                        break.x.by = 5,font.x = c(14, "bold","black"),font.y = c(14, "bold","black"),font.tickslab = c(12, "plain", "black"),
                        xlab ="Time in Year", pval = T, legend.title = "",ggtheme = theme(panel.background = element_rect(fill="white"),
                                                                                         #panel.grid.major.y = element_line(color="black",size = 0.5),
                                                                                         panel.border = element_rect(fill=NA,color="black", size=0.7)))
  print(Figure_1A)
  topptx(filename = "I:/PD&COPD/result/Figure_1A2.pptx", width = 8, height = 6)
  
} 
{ #* CVDMortality Figure 1B ####
  ...
  print(Figure_1B)
  topptx(filename = "I:/PD&COPD/result/Figure_1B.pptx", width = 8, height = 6)
...
{ #* ALL Mortality Figure 1C ####
  ...
  Figure_1C<-ggsurvplot(FIT_ALL_PD,conf.int =TRUE, fun = "cumhaz",  tables.theme = theme_cleantable(), palette=c("#0073C2E5", "#EFC000E5"), 
                        ...
                        xlab ="Time in Year",  pval = F, legend.title = "",ylim = c(0,0.2),ggtheme =  theme_calc())
  print(Figure_1C)
  topptx(filename = "I:/PD&COPD/result/Figure_1C.pptx", width = 8, height = 6)
} 
{ #* CIF Figure 2D ##### 
  ...
  CIF #print(CIF)
  NM_periodontitis_CVD<- as.data.frame(CIF[["No/Mild periodontitis CVD"]])
  NM_periodontitis_CVD$type<-"No/Mild periodontitis CVD"
  NM_periodontitis_CVD$group<-"CVD"
  NM_periodontitis_CVD$line<-"No/Mild periodontitis"
  MS_periodontitis_CVD<-as.data.frame(CIF[["Moderate/Severe periodontitis CVD"]])
  MS_periodontitis_CVD$type<-"Moderate/Severe periodontitis CVD"
  MS_periodontitis_CVD$group<-"CVD"
  MS_periodontitis_CVD$line<-"Moderate/Severe periodontitis"
  NM_periodontitis_Cancer<-as.data.frame(CIF[["No/Mild periodontitis Cancer"]])
  NM_periodontitis_Cancer$type<-"No/Mild periodontitis Cancer"
  NM_periodontitis_Cancer$group<-"Cancer"
  NM_periodontitis_Cancer$line<-"No/Mild periodontitis"
  MS_periodontitis_Cancer<-as.data.frame(CIF[["Moderate/Severe periodontitis Cancer"]])
  MS_periodontitis_Cancer$type<-"Moderate/Severe periodontitis Cancer"
  MS_periodontitis_Cancer$group<-"Cancer"
  MS_periodontitis_Cancer$line<-"Moderate/Severe periodontitis"
  NM_periodontitis_Other<-as.data.frame(CIF[["No/Mild periodontitis MORT"]])
  NM_periodontitis_Other$type<-"No/Mild periodontitis MORT"
  NM_periodontitis_Other$group<-"Others"
  NM_periodontitis_Other$line<-"No/Mild periodontitis"
  MS_periodontitis_Other<-as.data.frame(CIF[["Moderate/Severe periodontitis MORT"]])
  MS_periodontitis_Other$type<-"Moderate/Severe periodontitis MORT"
  ...
  Figure_1D
  ggsave("I:/PD&COPD/result/Figure_1D.pdf",Figure_1D,device = "pdf", width = 12, height = 6, units ="in",
...
Table_S4
write.table(Table_S4,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 4.csv",row.names =F,col.names =F )
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
colnames(Interpolation_weighted)
data<-Interpolation_weighted[,c('peryear','MORT_stat','Cancer_MORT_stat','PD','Age_status','Sex','Race_ethnicity','SES',
...
cox.res <- cph(Surv(peryear,Cancer_MORT_stat)~PD+
                 sdmvpsu,data=data, weights=weight,surv = T, x = T, y = T)
...
#MODEL1
cox.res <- cph(Surv(peryear,Cancer_MORT_stat)~PD+
                 sdmvpsu+Age_status+Sex+Race_ethnicity+SES
...
#MODEL2
cox.res <- cph(Surv(peryear,Cancer_MORT_stat)~PD+Age_status+Sex+Race_ethnicity+SES+
                 Smoking_status+Drinking_status+BMI_status+Physical_status+
                sdmvpsu,data=data, weights=weight,surv = T, x = T, y = T)
treated.sur <- survest(cox.res, newdata = data.treated, times = time) 
untreated.sur <- survest(cox.res, newdata = data.untreated, times = time)
...
#MODEL3
cox.res <- cph(Surv(peryear,MORT_stat)~PD+Age_status+Sex+Race_ethnicity+SES+
                 Smoking_status+Drinking_status+BMI_status+Physical_status+
                 HTN_status+T2D_status+HPL_status+Cohort+
                 sdmvpsu,data=data, weights=weight,surv = T, x = T, y = T)
treated.sur <- survest(cox.res, newdata = data.treated, times = time) 
...
write.table(Table_S5,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 5.csv",row.names =F,col.names =F )
...
{ #* Age #####
  ...
  model<-svycoxph(Surv(peryear, MORT_stat==1) ~
                    PD_diagnosis+Sex+Race_ethnicity+SES+
...
{ #* Sex #####
  ...
  #all
  model<-svycoxph(Surv(peryear, MORT_stat==1) ~
                    PD_diagnosis+Age_status+Race_ethnicity+SES+
                    Smoking_status+Drinking_status+BMI+Physical_status+
                    HTN_status+T2D_status+HPL_status
                  , design =rhcSvy_Sex)
  model_result<-summary(model)
...
write.table(Table_S6,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 6.csv",row.names =F,col.names =F )
...
{ #** all model #####
  ...
  #all model2
  model2<-svycoxph(Surv(peryear, MORT_stat==1) ~
                     CAL_mean+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
  model2_result<-summary(model2)
  P<-model2_result[["coefficients"]][1,"Pr(>|z|)"]
  HR<-as.numeric(model2_result[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
  result2 <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
  ...
  #all model3
  model3<-svycoxph(Surv(peryear, MORT_stat==1) ~
                     CAL_mean+Age_status+Sex+Race_ethnicity+SES+
                     Smoking_status+Drinking_status+BMI_status+Physical_status, design =rhcSvy)
  model3_result<-summary(model3)
...
{ #** Cancer model #####
  ...
  #Cancer model4
  model4<-svycoxph(Surv(peryear, Cancer_MORT_stat==1) ~
                     CAL_mean+Age+Sex+Race_ethnicity+SES+
                     Smoking_status+Drinking_status++BMI_status+Physical_status+
                     HTN_status+T2D_status+HPL_status+Cohort
                   , design =rhcSvy)
  model4_result<-summary(model4)
...
{ #** all model #####
  ...
  #all model2
  model2<-svycoxph(Surv(peryear, MORT_stat==1) ~
                     PPD_mean+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
  model2_result<-summary(model2)
  P<-model2_result[["coefficients"]][1,"Pr(>|z|)"]
  HR<-as.numeric(model2_result[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")])
  result2 <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
  ...
  #all model3
  model3<-svycoxph(Surv(peryear, MORT_stat==1) ~
                     PPD_mean+Age_status+Sex+Race_ethnicity+SES+
                     Smoking_status+Drinking_status+BMI_status+Physical_status, design =rhcSvy)
  model3_result<-summary(model3)
...
#Cbind
  ...
  Table<-rbind(Table,c("Cancer cause","","","",""))
  Table<-rbind(Table,c("Model 1",CAL[9,"HR_CI"],CAL[9,"P.value"],
                       PPD[9,"HR_CI"],PPD[9,"P.value"]))
  Table<-rbind(Table,c("Model 2",CAL[10,"HR_CI"],CAL[10,"P.value"],
                       PPD[10,"HR_CI"],PPD[10,"P.value"]))
  Table<-rbind(Table,c("Model 3",CAL[11,"HR_CI"],CAL[11,"P.value"],
                       PPD[11,"HR_CI"],PPD[11,"P.value"]))
  Table<-rbind(Table,c("Model 4",CAL[2,"HR_CI"],CAL[2,"P.value"],
                       PPD[12,"HR_CI"],PPD[12,"P.value"]))
  
  Table_S7<-as.data.frame(Table)
  Table_S7= data.frame(lapply(Table_S7, as.character), stringsAsFactors=FALSE)
  write.table(Table_S7,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 7.csv",row.names =F,col.names =F )
...
{ #* all model #####
  ...
  model2_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         CAL_quantile+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
  ...
  #all model3
  model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         CAL_quantile+Age_status+Sex+Race_ethnicity+SES+
                         Smoking_status+Drinking_status+BMI_status+Physical_status, design =rhcSvy)
  model3_all_result<-summary(model3_all)
...
{ #* Combine #####
 ...
 { #* all model #####
    ...
    #all model2
    model2_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                           CAL_qua+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
    model2_all_result<-summary(model2_all)
    ...
    #all model3
    model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                           CAL_qua+Age_status+Sex+Race_ethnicity+SES+
                           Smoking_status+Drinking_status+BMI_status+Physical_status, design =rhcSvy)
    model3_all_result<-summary(model3_all)
...
write.table(Table_S8,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 8.csv",row.names =F,col.names =F )
...
{ #* all model #####
  ...
  #all model2
  model2_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PPD_quantile+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
  model2_all_result<-summary(model2_all)
  P<-model2_all_result[["coefficients"]][1:3,"Pr(>|z|)"]
  HR<-model2_all_result[["conf.int"]][1:3,c("exp(coef)","lower .95","upper .95")]
  result2 <- data.frame('HR'=HR[,1],'lower .95'=HR[,2],'upper .95'=HR[,3],
  ...
  #all model3
  model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PPD_quantile+Age_status+Sex+Race_ethnicity+SES+
                         Smoking_status+Drinking_status+BMI_status+Physical_status, design =rhcSvy)
  model3_all_result<-summary(model3_all)
...
{ #* all model #####
  ...
  #all model2
  model2_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PPD_qua+Age_status+Sex+Race_ethnicity+SES, design =rhcSvy)
  model2_all_result<-summary(model2_all)
  P<-model2_all_result[["coefficients"]][1,"Pr(>|z|)"]
  HR<-model2_all_result[["conf.int"]][1,c("exp(coef)","lower .95","upper .95")]
  result2 <- data.frame('HR'=HR[1],'lower .95'=HR[2],'upper .95'=HR[3],
  ...
  #all model3
  model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         PPD_qua+Age_status+Sex+Race_ethnicity+SES+
                         Smoking_status+Drinking_status+BMI_status+Physical_status, design =rhcSvy)
  model3_all_result<-summary(model3_all)
...
write.table(Table_S9,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 9.csv",row.names =F,col.names =F )
...
{ #* Combine #####
  ...
  Table_S10
  write.table(Table_S10,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 10.csv",row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_S11
  write.table(Table_S11,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 11.csv",row.names =F,col.names =F )
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 29 Original data (Table S12) ####  
load(file="I:/PD&COPD/data/Original_weighted.Rdata")
...
{ #* section 18.5 Combine  Table S12 #####
  ...
  Table_S12<-Table
  write.table(Table_S12,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 12.csv" ,row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_S13
  write.table(Table_S13,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 13.csv",row.names =F,col.names =F )
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 29 Complete data (Table S14) ####  
load(file="I:/PD&COPD/data/Complete_weighted.Rdata")
...
{ #* section 18.5 Combine  Table S14 #####
  ...
  Table_S14<-Table
  write.table(Table_S14,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 14.csv" ,row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_S15
  write.table(Table_S15,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 15.csv",row.names =F,col.names =F )
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
{ #* Combine #####
  ...
  Table_S16
  write.table(Table_S16,sep = ",",file ="I:/PD&COPD/result/Supplementary Table 16.csv",row.names =F,col.names =F )
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# +++++++++++++++++++Figures++++++++++++++++++++++++++ ####
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 32 RCS for CAL and PPD (Figure S4) ####
setwd("I:/PD&COPD/result")
load(file="I:/PD&COPD/data/Interpolation_weighted.Rdata")
...
{#* All cause mortarity ####
  {#** CAL_mean ####
    ...
    colnames(RCS)
    for (i in 3:7) {
      fit <- cph(Surv(peryear,MORT_stat) ~ rcs(CAL_mean,i)+Age_status+Sex+Race_ethnicity+SES+
                   Smoking_status+Drinking_status+BMI_status+Physical_status+
    ...
    nk
    i
    fit <-  cph(Surv(peryear,MORT_stat)~rcs(CAL_mean,3)+Age_status+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
    ...
    text(refvalue + 0.5, 1.5, paste0("ref value = ","1.539")) 
    legend("topright",
           paste0(
  ...
  {#** PPD_mean ####
    ...
    colnames(RCS)
    for (i in 3:7) {
      fit <- cph(Surv(peryear,MORT_stat) ~ rcs(PPD_mean,i)+Age_status+Sex+Race_ethnicity+SES+
                   Smoking_status+Drinking_status+BMI_status+Physical_status+
                   HTN_status+T2D_status+HPL_status+Cohort,data=RCS, weight= weight,family = binomial())
      tmp <- extractAIC(fit)
      if(i == 3) {AIC = tmp[2]; nk = 3}
    ...
    nk
    i
    fit <-  cph(Surv(peryear,MORT_stat)~rcs(PPD_mean,3)+Age_status+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status+HPL_status+Cohort,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
    ...
    text(refvalue, 1.2, paste0("ref value = "," 1.418")) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
...
{#* CVD mortarity ####
  ...
  {#** CAL_mean ####
    ...
    limDown<-quantile(RCS[,"CAL_mean"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"CAL_mean"],na.rm = T)
    RCS<- RCS[!RCS[,"CAL_mean"]>=limUp&!RCS[,"CAL_mean"]<=limDown,]
    fit <-  cph(Surv(peryear,CVD_MORT_stat==1)~rcs(CAL_mean,3)+Age_status+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status+HPL_status+Cohort,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 3, paste0("ref value = ","1.564")) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
  ...
  {#** PPD_mean ####
    ...
    fit <-  cph(Surv(peryear,CVD_MORT_stat==1)~rcs(PPD_mean,3)+Age_status+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status+HPL_status+Cohort,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 5, paste0("ref value = ","1.400")) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
...
{#* Cancer mortarity ####
  ...
  {#** CAL_mean ####
    ...
    limDown<-quantile(RCS[,"CAL_mean"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"CAL_mean"],na.rm = T)
    RCS<- RCS[!RCS[,"CAL_mean"]>=limUp&!RCS[,"CAL_mean"]<=limDown,]
    fit <-  cph(Surv(peryear,Cancer_MORT_stat==1)~rcs(CAL_mean,4)+Age_status+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status+HPL_status+Cohort,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue+1, 1.2, paste0("ref value = ","1.539")) 
    legend("topright",
           paste0("\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
  ...
  {#** PPD_mean ####
    ...
    fit <-  cph(Surv(peryear,Cancer_MORT_stat==1)~rcs(PPD_mean,3)+Age_status+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status+HPL_status+Cohort,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 2, paste0("ref value = ","1.420")) 
    legend("topright",
           paste0("\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
    dev.off()
