...
{#* section 1.1 NHANES III Periodontitis diagnosis ####
  {#** section 1.1.1 Data Preparation ####
    PD_dia=read.table("I:/PD&COPD/data/NHANESIII/exam.dat",sep=",",fill=T)
  ...
  {#** section 1.1.7 data selction age>=30 ####
    adult=read.table("I:/PD&COPD/data/NHANESIII/adult.dat",sep=",",fill=T)
    ...
    save(PD_III,file="I:/PD&COPD/data/PD_III.Rdata")
  }
}
{#* section 1.2 NHANES 1999-2004 Periodontitis diagnosis ####
  {#** section 1.2.1 Data Preparation ####
    #periodontal_data
    OHXPER_9900<-read.xport("I:/PD&COPD/data/PD/OHXPERIO.XPT")
    OHXPERL_0102<-read.xport("I:/PD&COPD/data/PD/OHXPRL_B.XPT")
    OHXPERU_0102<-read.xport("I:/PD&COPD/data/PD/OHXPRU_B.XPT")
    OHXPERL_0304<-read.xport("I:/PD&COPD/data/PD/OHXPRL_C.XPT")
    OHXPERU_0304<-read.xport("I:/PD&COPD/data/PD/OHXPRU_C.XPT")
  ...
  {#** section 1.2.7 data selction age>=30 ####
    ...
    save(PD_CON1,file="I:/PD&COPD/data/PD_CON1.Rdata")
  }
}
{#* section 1.3 NHANES 2009-2014 Periodontitis diagnosis ####
  ...
  {#** section 1.3.8 data selction age>=20 ####
    ...
    save(PD_CON2,file="I:/PD&COPD/data/PD_CON2.Rdata")
  }
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 2. Depression Data <<<<< ####
{#* section 2.1 NHANES III Exclusion Data ####
  {#** section 2.1.1 Data Preparation ####
    exam=read.table("I:/PD&COPD/data/NHANESIII/exam.dat",sep=",",fill=T)
    exam$SEQN<-as.numeric(substring(exam$V1,1,5))
    exam$FEV<-as.numeric(substring(exam$V1,4469,4472))
    exam$FVC<-as.numeric(substring(exam$V1,4483,4487))
    COPD_III<-exam[,c("SEQN","FEV","FVC")]
    COPD_III$FEV_FVC[COPD_III$FEV==8888]<-NA
    COPD_III$FEV_FVC[COPD_III$FVC==88888]<-NA
    COPD_III$FEV_FVC<-COPD_III$FEV/COPD_III$FVC
    
    COPD_III$COPD_exam[COPD_III$FEV_FVC>=0.7]<-0
    COPD_III$COPD_exam[COPD_III$FEV_FVC<=0.7]<-1
    table(COPD_III$COPD_exam,useNA = "ifany")
    adult=read.table("I:/PD&COPD/data/NHANESIII/adult.dat",sep=",",fill=T)
    adult$SEQN<-as.numeric(substring(adult$V1,1,5))
    adult$bronchitis<-as.numeric(substring(adult$V1,1470,1470))
    adult$emphysema<-as.numeric(substring(adult$V1,1471,1471))
    adult$bronchitis[adult$bronchitis==9]<-NA
    adult$emphysema[adult$emphysema==8|adult$emphysema==9]<-NA
    table(adult$emphysema,useNA = "ifany")
    adult$COPD_self<-0
    adult$COPD_self[adult$bronchitis==1|adult$emphysema==1]<-1
    table(adult$COPD_self)
    colnames(adult)
    COPD_III<-merge(COPD_III,adult[,c("SEQN","COPD_self")],by = "SEQN",all.x = T)
    table(COPD_III$COPD_self,COPD_III$COPD_exam,useNA = "ifany")
    COPD_III$COPD[COPD_III$COPD_self==0&COPD_III$COPD_exam==0]<-0
    COPD_III$COPD[COPD_III$COPD_self==1|COPD_III$COPD_exam==1]<-1
    colnames(COPD_III)
    COPD_III<-COPD_III[,c("SEQN","COPD_exam","COPD_self","COPD")]
    save(COPD_III,file="I:/PD&COPD/data/COPD_III.Rdata")
...
{#* section 2.1 NHANES 1999-2004 Exclusion Data ####
  {#** section 2.1.1 Data Preparation ####
    ...
    COPD_DATA<-nhs_read(nhs_tsv('mcq')[c(1:3)],"mcq160k","mcq160g",Year = F,codebook = F)
    colnames(COPD_DATA)[1]<-"SEQN"
    COPD_DATA$COPD_exam<-NA
    COPD_DATA$COPD_self<-0
    COPD_DATA$COPD_self[COPD_DATA$mcq160k==1|COPD_DATA$mcq160g==1]<-1
    COPD_DATA$COPD<-COPD_DATA$COPD_self
    table(COPD_DATA$COPD_self,useNA = "ifany")
    COPD_CON1<-COPD_DATA[,c("SEQN","COPD_exam","COPD_self","COPD")]
    
    table(COPD_CON1$COPD,useNA = "ifany")
    save(COPD_CON1,file="I:/PD&COPD/data/COPD_CON1.Rdata")
  }
}
...
{#* section 2.1 NHANES 2009-2014 Exclusion Data ####
  {#** section 2.1.1 Data Preparation ####
    COPD_DATA<-nhs_read(nhs_tsv('spx')[c(3,5)],"spxnfev1","spxnfvc",Year = F,codebook = F)
    colnames(COPD_DATA)[1]<-"SEQN"
    COPD_DATA$FEV_FVC<-COPD_DATA$spxnfev1/COPD_DATA$spxnfvc
    COPD_DATA$COPD_exam[COPD_DATA$FEV_FVC>=0.7]<-0
    COPD_DATA$COPD_exam[COPD_DATA$FEV_FVC<=0.7]<-1
    COPD_exam<-COPD_DATA[,c("SEQN","COPD_exam")]
    
    COPD_DATA<-nhs_read(nhs_tsv('mcq')[c(6:8)],"mcq160k","mcq160g",Year = F,codebook = F)
    colnames(COPD_DATA)[1]<-"SEQN"
    COPD_DATA$COPD_self<-0
    COPD_DATA$COPD_self[COPD_DATA$mcq160k==1|COPD_DATA$mcq160g==1]<-1
    COPD_self<-COPD_DATA[,c("SEQN","COPD_self")]
    COPD_CON2<-merge(COPD_exam, COPD_self,by = "SEQN",all = T)
    COPD_CON2$COPD[COPD_CON2$COPD_self==0&COPD_CON2$COPD_exam==0]<-0
    COPD_CON2$COPD[COPD_CON2$COPD_self==1|COPD_CON2$COPD_exam==1]<-1
    table(COPD_CON2$COPD,useNA = "ifany")
    table(COPD_CON2$COPD_self,COPD_CON2$COPD_exam,useNA = "ifany")
    colnames(COPD_CON2)
    save(COPD_CON2,file="I:/PD&COPD/data/COPD_CON2.Rdata")
  }
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
save(EX_III,file="I:/PD&COPD/data/EX_III.Rdata")
...
save(EX_CON1,file="I:/PD&COPD/data/EX_CON1.Rdata")
...
save(EX_CON2,file="I:/PD&COPD/data/EX_CON2.Rdata")


# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 4. Periodontal status of DM patients <<<<< ####
load(file="I:/PD&COPD/data/COPD_III.Rdata")
load(file="I:/PD&COPD/data/COPD_CON1.Rdata")
load(file="I:/PD&COPD/data/COPD_CON2.Rdata")
load(file="I:/PD&COPD/data/PD_III.Rdata")
load(file="I:/PD&COPD/data/PD_CON1.Rdata")
load(file="I:/PD&COPD/data/PD_CON2.Rdata")
load(file="I:/PD&COPD/data/EX_III.Rdata")
load(file="I:/PD&COPD/data/EX_CON1.Rdata")
load(file="I:/PD&COPD/data/EX_CON2.Rdata")
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
III<-multimerge(list(COPD_III,PD_III,EX_III),by="SEQN",all=T)
COPD_patient_III<-subset(III,COPD==1)
COPD_PD_III<-subset(COPD_patient_III,!is.na(PD_diagnosis))
...
CON1<-multimerge(list(COPD_CON1,PD_CON1,EX_CON1),by="SEQN",all=T)
COPD_patient_CON1<-subset(CON1,COPD==1)
COPD_PD_CON1<-subset(COPD_patient_CON1,!is.na(PD_diagnosis))
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
CON2<-multimerge(list(COPD_CON2,PD_CON2,EX_CON2),by="SEQN",all=T)
COPD_patient_CON2<-subset(CON2,COPD==1)
COPD_PD_CON2<-subset(COPD_patient_CON2,!is.na(PD_diagnosis))
COPD_PD<-rbind(COPD_PD_III,COPD_PD_CON1,COPD_PD_CON2)
COPD_PD_all<-subset(COPD_PD,Pregnancy=="NO")
COPD_PD_all$Pregnancy<-NULL
save(COPD_PD_all,file="I:/PD&COPD/data/COPD_PD_all.Rdata")
save(COPD_PD_III,file="I:/PD&COPD/data/COPD_PD_III.Rdata")
save(COPD_PD_CON1,file="I:/PD&COPD/data/COPD_PD_CON1.Rdata")
save(COPD_PD_CON2,file="I:/PD&COPD/data/COPD_PD_CON2.Rdata")
record<-ls()
rm(list=record[which(record!='COPD_PD_all')])
...
save(MORT_III,file="I:/PD&COPD/data/MORT_III.Rdata")
save(MORT_CON1,file="I:/PD&COPD/data/MORT_CON1.Rdata")
save(MORT_CON2,file="I:/PD&COPD/data/MORT_CON2.Rdata")
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 6. Combine of PD & DM & Mortality <<<<< ####
{#* section 6.1 NHANES III Combine of data ####
  load(file="I:/PD&COPD/data/COPD_PD_III.Rdata")
  load(file="I:/PD&COPD/data//MORT_III.Rdata")
  III_base_mo_stat<-merge(COPD_PD_III,MORT_III,by = "SEQN",all= F)
...
{#* section 6.2 NHANES 1999-2004 Combine of data ####
  load(file="I:/PD&COPD/data/COPD_PD_CON1.Rdata")
  load(file="I:/PD&COPD/data/MORT_CON1.Rdata")
  CON1_base_mo_stat<-merge(COPD_PD_CON1,MORT_CON1,by = "SEQN",all.x = T)
...
{#* section 6.3 NHANES 2009-2014 Combine of data ####
  load(file="I:/PD&COPD/data/COPD_PD_CON2.Rdata")
  load(file="I:/PD&COPD/data/MORT_CON2.Rdata")
  CON2_base_mo_stat<-merge(COPD_PD_CON2,MORT_CON2,by = "SEQN",all.x = T)
...
save(III_baseline,file="I:/PD&COPD/data/III_baseline.Rdata")
save(CON1_baseline,file="I:/PD&COPD/data/CON1_baseline.Rdata")
save(CON2_baseline,file="I:/PD&COPD/data/CON2_baseline.Rdata")
